(function() {
    ...
    server = 'https://raw.github.com/juancgarcia/screenshotify/master/Downloadify-652377f' /*'//c9.io/juancgarcia/html2canvas/workspace/Downloadify-652377f'*/ /*'//html2canvas.hertzen.com/js'*/,
    ...
    scriptFiles = [
		...
		'js/swfobject',
		'js/downloadify.min',
        '//stuartk.com/jszip/jszip.js',
        '//stuartk.com/jszip/jszip-deflate.js'/*,
		'js/dZscript'*/
    ];
